    ...
    private static double calculateCGPA(Scanner sc, int T){
        ...
        for(int i=0; i<T; i++){
            ...
            if (endpractical.equalsIgnoreCase("Yes")){
                ...
                double[] values = {0.25, 0.25, 0.50};

                for (int a = 0; a < 3; a++) {
                    System.out.println("Enter " + prompts[a] + " marks for " + subjects + " out of " + weights[a] + ":");
                    double mark = sc.nextDouble();
                    double converstion = (mark / values[a]);
                    reviews[a] = converstion / 100 * weights[a];
                }
                //Total CGPA calculation
                ...
                double[] values = {0.20, 0.20, 0.15, 0.15, 0.30};

                for (int r = 0; r < internals.length; r++) {
                    System.out.println("Enter " + prompts[r] + " marks out of " + weights[r] + ":");
                    double mark = sc.nextDouble();
                    double converstion = (mark / values[r]);
                    internals[r] = converstion / 100 * weights[r];
                ...
                for (int z = 0; z < nptel.length; z++) {
                    System.out.println("Enter " + prompts[z] + " out of "+weights[z]+" marks:");
                    double mark = sc.nextDouble();
                    double converstion = (mark / values[z]);
